...
const WeatherResult: React.FC<IWeatherResult> = ({
  ...
  return (
    <div className="dark:text-white relative">
      ...
      <div className="rounded-[20px] md:rounded-[40px] bg-white/30 dark:bg-[rgb(26, 26, 26)]/30 p-5 md:p-10 border-[1px] border-white dark:border-none mt-[60px] md:mt-[150px]">
